function [p_one_electrode,num_one_electrode] = Topsurface_mesh_cube(pos1,pos2,mesh_size,bbox,plot_switch,figure_all_plot)
%mesh a cube
...
for is=1:num_surface
    ...
    if (is==1)
        ...
        [p,t]=distmesh2d(plot_switch,fd,@huniform,mesh_size,[min(x1,x2),min(y1,y2); max(x1,x2),max(y1,y2)],[x1,y1;x2,y1;x2,y2;x1,y2]);
        nt=size(t);

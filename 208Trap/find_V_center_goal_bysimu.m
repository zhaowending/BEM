...
v0=change_voltage_N_TO_N1(V); % delete a RF voltage 
[lb,ub]=set_upper_lower_limit_voltage_simulannealbnd(num_total_electrode,200,500,-10,10); % set the upper and lower limit of voltage
global list_center 
...
v=simulannealbnd(@(v)Goal_center_simulannealbnd_findvoltage(v,center_goal,num_total_electrode,xr,yr,zr,points,potential_basis,pseudo_C,um),v0,lb,ub,opts)

[v,fval,exitflag,output]=run(problem);

function [T_array,node_array,T_num_electrode,T_total,T_pos1,T_pos2] = mesh_trap302_DC_segement(T_array,node_array,T_num_electrode,T_total,T_pos1,T_pos2,DC_x,DC_y,en,mesh_divide,plot_switch,figure_all_plot,Z_depth,Z_surface,um)
...
%         mesh_size=8*um; 
%     end
    [p,num] = Topsurface_mesh_poly(pos1,pos2,op_x,op_y,mesh_mode,mesh_size,bbox,num_op,num_opand2,num_opand3,num_opall,plot_switch,figure_all_plot);

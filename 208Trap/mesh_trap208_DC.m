function [T_array,node_array,T_num_electrode,T_total,T_pos1,T_pos2] = mesh_trap302_DC(T_array,node_array,T_num_electrode,T_total,T_pos1,T_pos2,DC_x,DC_y,en,mesh_divide,plot_switch,figure_all_plot,Z_depth,Z_surface,um)
